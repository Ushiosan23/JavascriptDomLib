((w, d) => {
     ...
     * @param days cookie time.
     * @param path cookie location.
     */
    w.setCookie = (name, value, days = 1, path = '/') => {
        // Cookie time.
        let date = new Date();
     ...
     * Get cookie value.
     * 
     * @param name cookie to search.
     * @returns cookie value or null if not exists.
     */
    w.getCookie = name => {
        // Decoding cookie.
        let cookieName = `${name}=`,
